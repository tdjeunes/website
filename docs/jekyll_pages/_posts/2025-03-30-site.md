...
(7) d'avoir accès en écriture au <https://github.com/tdjeunes/website>. Notez que vous aurez accès en écriture à toutes les branches sauf `main`. Si vous voulez faire un changement à main, vous devez ouvrir une nouvelle branche, et ouvrir une PR.
