...
;
Drupal.locale = { 'pluralFormula': function($n) { return Number(($n!=1)); }, 'strings': {"Unspecified error":"Error no especificado","Join summary":"Unir resumen","Split summary at cursor":"Definir resumen hasta el cursor","Save":"Guardar","This field is required.":"Este campo es obligatorio.","Drag to re-order":"Arrastre para reordenar","Changes made in this table will not be saved until the form is submitted.":"Los cambios realizados en esta tabla no se guardar\u00e1n hasta que se env\u00ede el formulario","Select all rows in this table":"Seleccionar todas las filas de esta tabla","Deselect all rows in this table":"Quitar la selecci\u00f3n a todas las filas de esta tabla","The changes to these blocks will not be saved until the \u003cem\u003eSave blocks\u003c\/em\u003e button is clicked.":"Los cambios sobre estos bloques no se guardar\u00e1n hasta que no pulse el bot\u00f3n \u003cem\u003eGuardar bloques\u003c\/em\u003e.","Next":"Siguiente","jQuery UI Tabs: Mismatching fragment identifier.":"jQuery UI Tabs: Identificador de fragmento no coincidente.","jQuery UI Tabs: Not enough arguments to add tab.":"jQuery UI Tabs: No hay argumentos para a\u00f1adir solapa.","Save and send":"Guardar y enviar","Save and send test":"Guardar y enviar prueba","Feature Layer":"Capa de caracter\u00edsticas","Data Layer":"Capa de datos","The selected file %filename cannot be uploaded. Only files with the following extensions are allowed: %extensions.":"El archivo seleccionado %filename no puede ser subido. Solo se permiten archivos con las siguientes extensiones: %extensions.","Internal server error. Please see server or PHP logs for error information.":"Error interno del servidor. Por favor, consulte los registros de informaci\u00f3n de error del servidor o PHP.","Previous":"Anterior","Close":"Cerrar"} };;
